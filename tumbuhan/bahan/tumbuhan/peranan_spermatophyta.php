    ...
    <div class="btn">
      ...
      <nav class="sidebar">
        ...
        <ul>
          ...
          <li>
            <a href="#" class="dropdown-btn"  style=" color: cyan; background: #389761;">Tumbuhan Berbiji (Spermatophyta)
              <span class="fas fa-caret-down"></span>
            </a>
            <ul class="spe-tampil" style="display: block;">
              <li><a href="ciri_spermatophyta"  >Ciri-ciri Spermatophyta</a></li>
              <li><a href="peranan_spermatophyta" style=" color: cyan; background: #389761;">Klasifikasi Spermatophyta</a></li>
            </ul>
          </li>
