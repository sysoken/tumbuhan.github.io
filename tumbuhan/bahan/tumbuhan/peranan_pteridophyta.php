    ...
    <div class="btn">
      ...
      <nav class="sidebar">
        ...
        <ul>
          ...
          <li>
            <a href="#" class="dropdown-btn" style=" color: cyan; background: #389761;" >Tumbuhan Paku (Pteridophyta)
              <span class="fas fa-caret-down"></span>
            </a>
            <ul class="pte-tampil" style="display: block;">
              ...
              <li><a href="peranan_pteridophyta" style=" color: cyan; background: #389761;">Peranan Pteridophyta Bagi Manusia</a></li>
            </ul>
          </li>
          <li>
